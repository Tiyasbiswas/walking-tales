            ...
            <div class="container py-3">
                    ...
                    <div class="row ">
                        ...
                        <div class="col-md-7 px-3 ">
                            <div class="card-block px-6">
                                <h4 class="card-title">What Are the Benefits of Walking?  </h4>
                                ...
                                <br />
                                <a href="https://www.health.harvard.edu/staying-healthy/5-surprising-benefits-of-walking" class="mt-auto btn btn-success btn-sm ">Read More</a>
                            </div>
                        </div>
                        <div class="col-md-4 float right">
                            <img class="blog-block" src="./images/img2.jpg" alt="" />
                        </div>
                    </div>
                </div>
                ...
                <div class="cardcontainer">
                    <div class="row ">
                        ...
                        <div class="col-md-7 px-3 ">
                            <div class="card-block px-6">
                                <h4 class="card-title">How Many Calories Do You Burn is Enough? </h4>
                                <p class="card-text mt-4">
                                ...
                                <br />
                                <a href="https://www.healthline.com/health/fitness-exercise/how-many-calories-do-i-burn-a-day" class="mt-auto btn btn-success btn-sm ">Read More</a>
                            </div>
                        </div>
                        <div class="col-md-4 float right">
                            <img class="blog-block" src="./images/img1.jpg" alt="" />
                        </div>
                    </div>
                </div>
                ...
                <div class="cardcontainer">
                    <div class="row ">
                        ...
                        <div class="col-md-7 px-3 ">
                            <div class="card-block px-6">
                                <h4 class="card-title">Surprising Benefits of Walking with a partner?  </h4>
                                <p class="card-text mt-4">
                                ...
                                <br />
                                <a href="#" class="mt-auto btn btn-success btn-sm ">Read More</a>
                            </div>
                        </div>
                        <div class="col-md-4 float right">
                            <img class="blog-block" src="./images/img3.jpg" alt="" />
                        </div>
                    </div>
                </div>
                ...
                <div class="cardcontainer">
                    <div class="row ">
                        ...
                        <div class="col-md-7 px-3 ">
                            <div class="card-block px-6">
                                <h4 class="card-title">Health Benefits of Physical Activity for Adults </h4>
                                <p class="card-text mt-4">
                                ...
                                <br />
                                <a href="https://www.cdc.gov/physicalactivity/basics/index.htm" class="mt-auto btn btn-success btn-sm ">Read More</a>
                            </div>
                        </div>
                        <div class="col-md-4 float right">
                            <img class="blog-block" src="./images/img4.jpg" alt="" />
                        </div>
                    </div>
                </div>
                ...
                <div class="cardcontainer">
                    <div class="row ">
                        ...
                        <div class="col-md-7 px-3 ">
                            <div class="card-block px-6">
                                <h4 class="card-title">Is Mental Health realted to Exercise? </h4>
                                <p class="card-text mt-4">
                        ...
                        <div class="col-md-4 float right">
                            <img class="blog-block" src="./images/img5.jpg" alt="" />
                        </div>
                    </div>
                </div>
                ...
                <div class="cardcontainer">
                    <div class="row ">
                        ...
                        <div class="col-md-7 px-3 ">
                            <div class="card-block px-6">
                                <h4 class="card-title"> Top Reasons Why Workout Gear and Equipment Is So Important</h4>
                                <p class="card-text mt-4">
...
The type of equipment and gear chose will vary depending on an individual’s fitness and health goals......</p>
                                <br />
                                <a href="https://fitboxmethod.com/top-reasons-why-workout-gear-and-equipment-is-so-important/" class="mt-auto btn btn-success btn-sm ">Read More</a>
                            </div>
                        </div>
                        <div class="col-md-4 float right">
                            <img class="blog-block" src="./images/img6.jpg" alt="" />
                        </div>
                    </div>
                </div>
